...
val orderedIntersections = intersections.sortWith((a, b) => a.manhattanDistance <= b.manhattanDistance)

val closest = orderedIntersections.head

println(s"CLOSEST INTERSECTION: $closest, MANHATTAN DISTANCE: ${closest.manhattanDistance}" )
